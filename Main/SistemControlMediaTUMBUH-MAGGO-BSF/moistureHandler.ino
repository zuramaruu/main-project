...
void bacaMoisture() {
  ...
  moisture_value[0] = map(moisture_value[0], 300, 1023, 100, 0);
  moisture_value[1] = map(moisture_value[1], 300, 1023, 100, 0);
  moisture_value[2] = map(moisture_value[2], 300, 1023, 100, 0);
