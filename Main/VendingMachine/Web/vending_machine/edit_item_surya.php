...
<div class="row" style="height:  100vh">
    ...
    <div class="col-8 p-5   ">
        ...
        if (isset($_GET["submit"]) and $_GET["submit"] == "submit") {
            ...
            $surya_insert = $_GET["surya_form"];
            $total_surya = 0;

            $total_surya = $surya_insert + getStock("surya", $IDBoard, "list_item", $koneksi);
            if ($total_surya > 4) {
                $valid = 2;
            } else {

                $sql = "UPDATE list_item  SET surya=? WHERE id_board = ?";
                if ($stmt = $koneksi->prepare($sql)) {

                    $stmt->bind_param("ii", $total_surya, $IDBoard);
                    if ($stmt->execute()) {
                    ...
                    <div class="card-body text-center">
                        ...
                        <form>
                            <div class="mb-3 form-group">
                                <input type="number" class="form-control rounded-left" id="surya_form" name="surya_form"
